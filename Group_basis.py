...
def Basis_clg(e,S,l,n,h1):
	...
	* h1: small integer (typically h(O_1))
	...
	Returns a basis B of the group G generated by S as one element if G is cyclic and two elements
	...
	for i in range(t):
		if S_test[i]**l!=e:
			g0*=S1[i]
			return [g0]# At this stage, we know the group is cyclic and we stop
